...
public class CreateResult {
	...
	GridReporter reporter = new GridReporter();
	...
	public static String now() {
	    ...
	    //String strConfigFileName = "/Users/testlab-imac/Documents/workspace/iPhoneTest/src/com/tes/results/screenshot/";
        ...
        strScreenshot = (String) (strScreenshotPath + sdf.format(cal.getTime())+num +".png");
        return sdf.format(cal.getTime());
    }
								//String sce_name,String test_case_name,String exp_result,String Act_result, String Description, boolean Screenshot, String result, AndroidDriver driver
	...
	//public void takeScreenshot(String strScenarioName,int testStep, String strResultDescription, boolean Screenshot, String result, RemoteWebDriver iPhoneDriver) {
        try {
            Calendar cal = Calendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_NOW);
	...
	public void writeStepResult(String strScenarioName,String strStepDescription,String strstrTestData, String strStatus, boolean isScreenshot, RemoteWebDriver webDriver) {
		//public void takeScreenshot(String strScenarioName,int testStep, String strResultDescription, boolean Screenshot, String result, RemoteWebDriver iPhoneDriver) {
	        try {
	            Calendar cal = Calendar.getInstance();
	            SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_NOW);
	   ...
	   public void reportGenerator() {
			...
			try {
				...
				String strReportFile = utils.getResultPath() + utils.getConfigValues("Browser Type")+ "_Report" + "_" + time + ".html";
	...
	public void reportGenerator_Prasad() {
		...
		try {
			...
			String strReportFile = "/Users/testlab-imac/Documents/workspace/iPhoneTest/src/com/tes/results/" +"Report" + "_" + time + ".html";
    ...
    /*
      public void takeScreenshot(String sce_name,String test_case_name,String exp_result,String Act_result, String Description, boolean Screenshot, String result, RemoteWebDriver iPhoneDriver) {
	
        try {
            Calendar cal = Calendar.getInstance();
            SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_NOW);
            tempList_scenario_name.add(sce_name);
            tempList_testCase_name.add(test_case_name);
            tempList_exp_result.add(exp_result);
            tempList_act_result.add(Act_result);
            ...
            if (Screenshot) {
                ...
                Random rand = new Random();
                int num = rand.nextInt(1000);
                screenshot = (String) (strConfigFileName + sdf.format(cal.getTime())+num +".png");
                File testScreenShot = new File(strConfigFileName ,sdf.format(cal.getTime())+num + ".png");
   
                try {

                    //Copy the file to screenshot folder 
                	File srcFile = ((TakesScreenshot)iPhoneDriver).getScreenshotAs(OutputType.FILE);
                ...
                tempList_location.add(screenshot);
            } else {
